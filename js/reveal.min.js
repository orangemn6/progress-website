(function(root, factory) {
    ...
    var SLIDES_SELECTOR = ".slides section",
        ...
        loaded = false,
        overview = false,
        indexh, indexv, previousSlide, currentSlide, previousBackground, state = [],
        scale = 1,
        slidesTransform = {
            layout: "",
            overview: ""
        ...
        dom = {},
        features = {},
        isMobileDevice, lastMouseWheelStep = 0,
        writeURLTimeout = 0,
    ...
    function colorToRgb(color) {
        ...
        if (hex3 && hex3[1]) {
            hex3 = hex3[1];
            return {
                r: parseInt(hex3.charAt(0), 16) * 17,
                g: parseInt(hex3.charAt(1), 16) * 17,
                b: parseInt(hex3.charAt(2), 16) * 17
            }
        }
    ...
    function showPreview(url) {
        ...
        dom.overlay.innerHTML = ["<header>", '<a class="close" href="#"><span class="icon"></span></a>', '<a class="external" href="' + url + '" target="_blank"><span class="icon"></span></a>', "</header>", '<div class="spinner"></div>', '<div class="viewport">', '<iframe src="' + url + '"></iframe>', "</div>"].join("");
    ...
    function updateOverview() {
        ...
        transformSlides({
            overview: ["translateX(" + -indexh * slideWidth + "px)", "translateY(" + -indexv * slideHeight + "px)", "translateZ(" + (window.innerWidth < 400 ? -1e3 : -2500) + "px)"].join(" ")
        })
    }
            ...
            if (currentSlide.querySelectorAll(".fragment").length === 0) {
                toArray(currentSlide.querySelectorAll("video, audio")).forEach(function(el) {
                    if (el.hasAttribute("data-autoplay")) {
                        if (autoSlide && el.duration * 1e3 > autoSlide) {
                            autoSlide = el.duration * 1e3 + 1e3
                        }
                    }
                })
            }
    ...
    Playback.prototype.animate = function() {
        ...
        if (progressBefore > .8 && this.progress < .2) {
